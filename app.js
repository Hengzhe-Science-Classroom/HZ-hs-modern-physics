// === The Modern Physics · Interactive - Core Application ===
...
const App = {
    ...
    // --- Progress ---
    loadProgress() {
        try { this.progress = JSON.parse(localStorage.getItem('hs-modern-physics-progress') || '{}'); }
        catch (e) { this.progress = {}; }
    },
    saveProgress() {
        try { localStorage.setItem('hs-modern-physics-progress', JSON.stringify(this.progress)); } catch (e) {}
    },
